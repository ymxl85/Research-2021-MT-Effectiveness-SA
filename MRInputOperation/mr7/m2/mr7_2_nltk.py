...
if __name__ == '__main__':
    ...
    while index<=count:
        ...
        data_os=[]
        data_f=[]
        s_path = "E:/MT_SA/data/input/mr7_2/nltk/s%s.txt" %index
        if os.path.exists(s_path):
            os_path="E:/MT_SA/data/output/mr7_2/nltk/os%s.txt" %index
            ...
            f_path="E:/MT_SA/data/input/mr7_2/nltk/f%s.txt" %index
